...
# --------------------------------- TERRA MOSAIC ------------------------------- #
def getTerra():
    # https://gibs.earthdata.nasa.gov/image-download?TIME=2018186&extent=-2251630.1978347152,
    # -1767716.822874052,2386588.9709421024,1917931.4225647242&epsg=3413&
    # layers=MODIS_Terra_CorrectedReflectance_TrueColor,Coastlines&opacities=1,1&worldfile=true&
    ...
    'extent=%s&epsg=3413&layers=%s&opacities=1,1&worldfile=true&' %(extent, layers) + \
    'format=image/jpeg&width=4530&height=3599'
    print(query)
getTerra()
